...
We created an instrument to measure the variables of the NAM and TPB with regards to fighting wrongful imprisonment. The item wordings were based on previous studies using the NAM and TPB to explain social justice engagement [@torres-harding2012], charitable giving [@smith2007], and pro-environmental behaviour [@degroot2009; @savari2023; @steg2010].
