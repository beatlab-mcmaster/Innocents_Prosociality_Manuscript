...
fig_awareness_study1 <- plot_meanSE(df = subset(combined_long, study == "Study 1"), dv = "jitter_awareness", ylab = "Problem Awareness", xlab = "Stimulus") + facet_wrap(vars(facet), scales = "free")

fig_awareness_study2 <- plot_meanSE(df = subset(combined_long, study == "Study 2"), dv = "jitter_awareness", ylab = "Problem Awareness", xlab = "") + facet_wrap(vars(facet), scales = "free") 
...
fig_empathy_study1 <- plot_meanSE(df = subset(combined_long, study == "Study 1"), dv = "jitter_anna_empathy", ylab = "Empathic Concern", xlab = "Stimulus") + facet_wrap(vars(facet), scales = "free")

fig_empathy_study2 <- plot_meanSE(df = subset(combined_long, study == "Study 2"), dv = "jitter_anna_empathy", ylab = "Empathic Concern", xlab = "") + facet_wrap(vars(facet), scales = "free") 
...
fig_closeness_study1 <- plot_meanSE(df = subset(combined_long, study == "Study 1"), dv = "jitter_ios_anna", ylab = "Relationship Closeness", xlab = "Stimulus") + facet_wrap(vars(facet), scales = "free")

fig_closeness_study2 <- plot_meanSE(df = subset(combined_long, study == "Study 2"), dv = "jitter_ios_anna", ylab = "Relationship Closeness", xlab = "") + facet_wrap(vars(facet), scales = "free") 
ggpubr::ggarrange(
        fig_closeness_study1,
        fig_closeness_study2 + theme(axis.title.y = element_blank()),
        nrow = 1, 
        ncol = 2,
        widths = c(2.2, 1),
        legend = "bottom",
