...
The aim of social justice advocacy is to foster engagement with a social justice issue and mobilize supportive behaviour for that cause. How social justice behaviour emerges has been studied under different names - including prosocial behaviour, altruism, philanthropy, and charitable behaviour - by scholars from different disciplines, resulting in a variety of theories and models [@bekkers2011]. This issue of parallel theories is not limited to the study of social justice behaviour: Psychological research more broadly has been critized for hindering research progress by investigating individual theories in isolation, when instead accumulation and integration would be necessary to further our understanding of human behaviour [@muthukrishna2019; @almaatouq2024]. Beyond scholarly inefficiency, parallel theories also hinder the application of psychological research, leaving practitioners confused about which factors are decisive in which context [@deleeuw2022]. It is therefore necessary to empirically compare the predictions of different theories of social justice behaviour [@bekkers2011]. In this study, we compare normative, empathic, and relational influences on social justice behaviour.
