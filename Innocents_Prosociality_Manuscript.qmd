...
medium_cols <- ordermedium_cols[c(1, 3)] # Film, Performance
...
combined_long <- study1_3long %>%
  ...
  mutate(study = factor(study, labels = c("Study 1", "Study 2")),
        ...
        jitter_pleasure = jitter(pleasure, amount = .15),
        jitter_awake = jitter(awake, amount = .15),
        jitter_tense = jitter(tense, amount = .15) 
        ) 
```

# Introduction 

Despite our shared struggle for a better world, societies remain unjust. For example, criminal justice systems were implemented to enforce justice, but across societies, systemic issues lead to the wrongful imprisonment of innocent individuals. Arts and media are a way of reaching and engaging broad audiences to mobilize support to fight social injustices such as wrongful imprisonment. Film, TV, and theatre, using the power of storytelling, can shape attitudes and behaviours with regards to social injustice. Music is also commonly used to advocate for social justice issues, for instance in the forms of charity concerts and protest songs. Given that music typically has less storytelling than the previously mentioned media, it remains unclear how socially responsible music promotes audiences' engagement with social justice issues. While previous research has uncovered how music shapes our evaluation of the people making the music or listening to it [e.g., @onderdijk2021; @swarbrick2023; @rabinowitch2023; @chang2021; @boer2011; @lonsdale2009; @rentfrow2009], few studies have investigated how music influences our views of the people and issues that are the subject of music. In addition, though theories of prosocial and charitable behaviour propose various predictors that could explain how arts and media can advocate for social justice issues, this plurality makes it difficult for researchers to integrate previous works, and for artists to understand which factors are decisive to effectively engage their audience.

In two studies, we evaluate how an abstract music performance engages audiences with the issue of wrongful imprisonment, compared to a narrative documentary film. We assess changes in three affective and cognitive variables, empathic concern, relationship closeness, and problem awareness, and compare their influence on supportive behaviours observed in audiences in the concert hall and at home. This study provides empirical support for the mobilizing potential of music as a medium with less narration, and highlights which attitudinal facet artists should appeal to in order to gain support for their cause.

## Mobilizing support for social justice causes

The aim of social justice advocacy is to foster engagement with a social justice issue and mobilize supportive behaviour for that cause. How social justice behaviour emerges has been studied under different keywords - including prosocial behaviour, altruism, philanthropy, and charitable behaviour - by scholars from different disciplines, resulting in a variety of theories and models [@bekkers2011]. This issue of parallel theories accounting for the same phenomenon is not limited to the study of social justice behaviour: Psychological research more broadly has been criticized for slowing research progress because researchers investigate their pet theory in isolation, when instead theory integration would be necessary to further our understanding of human behaviour [@muthukrishna2019; @almaatouq2024]. Beyond scholarly inefficiency, parallel theories also hinder the application of psychological research by confusing practitioners about which factors are decisive in which context [@leeuw2022]. It is therefore necessary to empirically compare the predictions of different theories of social justice behaviour [@bekkers2011]. In this study, we compare normative, empathic, and relational influences on social justice behaviour.

Justice is a moral concept, and supporting social justice causes can be conceived as morally-driven behaviour. The norm activation model [NAM, @schwartz1977] lays out the process of how personal norms create a moral obligation to act. According to the model, an actor first has to become aware of a problematic situation (e.g., wrongful imprisonment) that puts those affected (e.g., innocent prisoners) in distress. Subsequently, the actor needs to feel responsible for changing the problematic situation and responding to the distress of those affected. As a third component, the problem must be relevant to the personal norms of the actor (e.g., justice in the legal system), for these norms to be activated and guide the actor's behaviour. In combination, problem awareness, ascription of responsibility, and personal norms create a moral obligation to help reduce the distress of those affected (e.g., by making a donation to an NGO that re-investigates cases of wrongful imprisonment), so that the actor acts in accordance with their norms [@schwartz1977; @degroot2009]. Importantly, the NAM postulates a causal chain of the three components, which explains why people do not always adhere to all of their norms: If one is not aware of a problem or does not believe that they can change it, their norms are not activated in that situation and therefore can not guide their behaviour [although the empirical evidence regarding this causal chain is mixed\; @klockner2013].

Studies on prosocial and pro-environmental behaviour [e.g., @degroot2009; @savari2023; @steg2010] commonly integrate the NAM with the theory of planned behaviour [TPB, @ajzen1991; @ajzen2011]. While there is some conceptual overlap between the constructs of the two theories, the TPB crucially contributes the *behavioural intention* as the most proximal predictor of behaviour. The idea is that rational (or planned) behaviour is always preceded by a decision to engage in that behaviour. Therefore, all other predictors of behaviour influence this decision, which in turn mediates the actual behaviour [@ajzen1991; @ajzen2011]. Separating intention and behaviour reduces noise in analyses, because the translation of intention into behaviour can be hindered by external factors beyond the scope of motivational research [e.g., lack of resources, or unexpected situations\; @sheeran2002]. Taken together, the NAM and TPB suggest that social justice advocacy can mobilize supportive behaviour by raising awareness for a problem, appealing to the audience's responsibility, or strengthening norms regarding social justice, which contribute to the intention to support the social justice cause. However, problem awareness might have to precede the other components, especially when the social justice issue is lesser known.

Beyond the moral motive, altruistic motives can promote the support of social justice causes. According to the empathy-altruism hypothesis, empathically adopting the perspective of a person in need creates an altruistic motivation to reduce their suffering. For example, empathizing with the experience of an innocent prisoner may give rise to a sense of concern about their well-being, which translates into a motivation to help improve the well-being of the innocent prisoner, irrespective of the behavioural consequences for oneself [@batson1987; @batson2011]. There has been a long debate on whether helping can be purely altruistic, in that the actor is only acting in the interest of the person receiving the help, or whether the actor always has an egoistic interest to reduce their own distress arising from witnessing the other person suffering [e.g., @cialdini1997; for a review, see @batson2011]. Both empathic concern and personal distress, however, arise from empathic perspective-taking. <!-- TODO add that empathizing is effortful, therefore motivate audiences to empathize (rather than improve their ability to empathize; Weisz & Zaki, 2017). --> Hence, social justice advocacy can mobilize supportive behaviour by conveying the experiences and point of view of those affected by the social justice issue, thereby facilitating empathic responses from the audience.

Finally, social relationships play an important role in supporting social justice causes. A body of literature reports that perceived similarity and familiarity with another person strengthen the tendency to help them [@burger2004; @batson1981; @batson1995; @sole1975]. One possible explanation is that if one feels closer to a person in need, it is easier to empathize with their need, and one cares more for their well-being, thus facilitating the empathically motivated altruism described above [@batson1981; @batson1995; @sturmer2009]. In another line of argumentation, if one feels closer to a person in need, one values their social approval more and therefore might help them in hopes of getting their approval, or avoiding the risk of social punishment for not helping them [@bekkers2011]. These lines of argumentation suggest that social justice advocacy can mobilize supportive behaviour by tightening the social bonds between audiences and those affected by the social justice issue, which should increase the tendency to help.

<!-- TODO conceptual figure --> 

## Advocacy through art

Social injustices often become the subject of art. Beyond a mere inspiration or description of society, art often criticizes social injustices and advocates for change. Empirical evaluations of such advocacy through art have demonstrated effects of media like documentary films, theatre, and songs on the aforementioned normative, empathic, and relational dimensions, and on behaviour in support of social justice causes. For example, @reddan2024 compared audience responses to a documentary about wrongful imprisonment with two documentaries about injustices in sports, and found that the former enhanced audiences' empathic responses towards prisoners, attitudes towards prison reform, and intentions to support a petition to restore voting rights for people with felony convictions. While this study is unique in its focus on documentaries on social issues, its results are consistent with the somewhat larger body of literature attesting that documentaries about climate change can increase audiences' concern and pro-environmental intentions [@howell2011; @nolan2010; @sakellari2015]. Turning to theatre, audiences of performances about disadvantaged groups have been shown to be more empathetic with the represented groups and more willing to donate to charity after the performance, compared to before. Effects on measures of attitude change remained ambiguous [@rathje2021]. Moreover, even songs with prosocial lyrics like "Love Generation" by Bob Sinclair, though much shorter than documentaries or theatre, can prompt prosocial thoughts and empathic responses in listeners, with empathy mediating the effect of the lyrical content on charitable donations [@greitemeyer2009; @greitemeyer2009a; @hong2023].

Most of the research cited above theorizes that art, be it film, theatre, or song, achieves its advocacy effect through powerful narratives influencing audiences' emotions and cognition regarding the advocacy topic. However, not all art makes use of explicit narration. Visual art, for example, often conveys social critique in an implicit, symbolic, or abstract manner [e.g., @pelowski2024]. Similarly, much music beyond the song form is carried more by sounds and less by lyrics, and therefore has fewer tools for explicit narration. Still, there are many examples of classical and jazz music intended to advocate for concrete issues: The West-Eastern Divan Orchestra for instance, a classical symphony orchestra with Israeli and Palestinian musicians, promotes a peaceful solution to the Arab-Israeli conflict by playing for concert audiences and politicians alike (<https://west-eastern-divan.org/>). Jazz icons sonified the struggle for racial justice with works such as Duke Ellington's *Black and Tan Fantasy*, Oscar Peterson's *Hymn to Freedom*, and John Coltrane's *Alabama* (<https://naacpsfnm.org/jazz-and-civil-rights/>). In the current study, we evaluate Allen Otte and John Lane's *The Innocents,* a percussion performance about wrongful imprisonment in the United States, touring schools and universities to educate and engage its audience with this often overlooked social injustice (<https://www.the-innocents.com/>). How does such music mobilize support for social justice causes, if not through explicit narrative lyrics?

Music excels at deliberately eliciting specific intended emotions in the listener<!-- [@trevor2024]-->. Music-induced eudaimonic emotions, such as feeling moved or in awe, are thought to connect the listener to others and promote prosocial behaviour irrespective of lyrical content or narrative [@tukachinskyforster2025]. This proposition is supported by research showing that emotional music without lyrics facilitates empathy and willingness to help, compared to neutral music [@McDonald2022] or happy music [@Wu2025]. More generally, musical activities can promote empathy [@clarke2015; @rabinowitch2013; @tzanaki2025] and strengthen social bonds with other musicians and listeners [@savage2021; @mogan2017; @swarbrick2023]. However, there is an ongoing debate as to who those social bonds extend to, beyond the musicians and listeners who are part of the music experience [@rabinowitch2023; @cirelli2016; @reddish2014; @reddish2016; @cross2020; @cross2019; @fink2021]. This latter aspect is crucial for advocacy contexts, because the recipients of charitable behaviour are usually absent during the advocacy [e.g., when an activist speaks to a potential donor at a fundraiser for prison reforms, the affected prisoners usually are not present, @bekkers2011]. Here, we build on existing research on art advocacy, such as songs with prosocial lyrics, and prosocial effects of music activities more generally. We extend previous work by investigating the advocacy effects of a music performance with a specific advocacy aim that is pursued less through narrative (compared to songs) and more through emotions. Because most research on art advocacy and prosocial effects of art has studied narrative media, we compare the effects of the music to those of a narrative documentary film.

## Collective aspects of audience experience

Historically, audiences of both music and film would typically gather together in a concert venue or cinema to collectively experience a performance or screening. Over the past decades, however, inventions such as disc storage devices, and more recently online streaming services, have led to a shift towards individual experiences of music and film in private audiovisual environments at home or via individual screens and headphones. Media and communications scholars have theorized that being part of an audience gives rise to a different experience than watching or listening alone: For music, @hargreaves2005 emphasize that the presence or absence of others influences both the listener's response to music, as well as the performer and thereby the music itself. Live music performances, other than recorded or broadcast performances, allow for bidirectional communication between spatio-temporally co-present performers and audience members: The performer can communicate through more channels than just the sound itself (e.g., body movements), and the audience can shape the performance through their immediate reactions. @wald-fuhrmann2021 corroborate the importance of the presence of musicians and audience members in shaping audiences' aesthetic experience of concerts. In addition to the communication between musicians and audience members, they also highlight the influence of the communication among audience members during, as well as before and after a music performance, and of the synchronization of bodily responses (like moving and cardiorespiratory activity) of co-present audience members. For film audiences, similar considerations have been put forward: Expressions (e.g., laughter) of other audience members can influence the viewing experience, but even a quietly attentive audience is aware of each other's presence, making collective film viewing in cinemas a social experience distinct from individual viewing at home [@hanich2014].

Empirical evidence confirms that music that is experienced together with other audience members elicits more intense emotional reactions [@liljestrom2013; though see @egermann2011 and @belfi2021], immersion and absorption [@kreuzer2025; @swarbrick2024], and intellectual stimulation [@kreuzer2025], than experiencing the same music alone or as part of a virtual audience. Regarding collective film viewing, @kaltwasser2019 report that some participants had physiological reactions to the co-presence of other audience members, though self-reported emotional reactions did not differ between collective and individual viewing conditions. Note that the studies reporting no differences had small sample sizes and thus lack the power to conclude the absence of an effect.

Very little is known about how the presence of other audience members might affect the mobilization potential of advocacy through art. This question is all the more relevant given that big charity concerts reach more livestream viewers at home than in-person attendees at the venue (from televised classics like Live Aid to entirely digital events like One World Together at Home). Swarbrick and colleagues found that co-presence in time and/or space strengthens connectedness among concert audiences [@swarbrick2021; @swarbrick2023; @onderdijk2021], suggesting that the co-presence of the performers (in the case of music, but not film) and of other audience members (for both film and music) might facilitate advocacy effects via stronger social bonds. <!-- @altenmuller20240909: social presence of audience could activate deeper processing or could distract from aesthetic experience (in museum context) -->To our knowledge, this is the first study to compare art advocacy effects in individual vs. collective audiences. 
...
We assessed affect with six items rated on a 4-point scale ranging from 1 ("I do not feel it") to 4 ("I feel it strongly"). The six items were combined into three bipolar dimensions alert-tired, relaxed-tense, and positive-negative by subtracting the rating of one pole from the rating of the opposite pole [@schimmack2000]. <!-- TODO explore single items with regards to mixed affect (feeling both happy and sad; e.g. tukachinskyforster2025) -->
...
rm(ec_1sthalf_film, ec_1sthalf_film_d, ec_1sthalf_perf, ec_1sthalf_perf_d, ec_2ndhalf_film, ec_2ndhalf_film_d, ec_2ndhalf_perf, ec_2ndhalf_perf_d, innocents_posthoctest, ios_1sthalf_film, ios_1sthalf_film_d, ios_1sthalf_perf, ios_1sthalf_perf_d, ios_2ndhalf_film, ios_2ndhalf_film_d, ios_2ndhalf_perf, ios_2ndhalf_perf_d, pa_1sthalf, pa_1sthalf_d)
...
# check_assumptions(study2_intention_outcomes, "behavioural_intention_z", study2_intent) # non-normal residuals
# 
# # extract residuals
# intention_residuals <- resid(study2_intention_outcomes, type = "pearson")
# # Find the indices of the most extreme residuals
# order(abs(intention_residuals), decreasing = TRUE)[1:3] 
# intention_residuals[c(83, 33, 80)] # indices: 87        36

study2_intention_outcomes <- lm(behavioural_intention_z ~ liking_z + ios_anna_z + anna_empathic_concern_z + problem_awareness_z, data = study2_intent[-c(87, 36), ])
# check_assumptions(study2_intention_outcomes, "behavioural_intention_z", study2_intent[-c(87, 36), ])

study2_intention_outcomes2 <- lm(behavioural_intention_z ~ liking_z + ios_anna_z + target_empathic_concern_z + problem_awareness_z, data = study2_intent)
# check_assumptions(study2_intention_outcomes2, "behavioural_intention_z", study2_intent)

study2_intention_outcomes3 <- lm(behavioural_intention_z ~ liking_z + ios_target_z + target_empathic_concern_z + problem_awareness_z, data = study2_intent)
# check_assumptions(study2_intention_outcomes3, "behavioural_intention_z", study2_intent)
...
awareness_f2 <- (summary(study2_intention_outcomes)$r.squared - summary(study2_intention_target_dropawareness)$r.squared) / (1 - summary(study2_intention_outcomes)$r.squared)
```
...
tab_model(intention_outcomes, study2_intention_outcomes, study2_intention_outcomes2, study2_intention_outcomes3, show.ci = T, 
          ...
          dv.labels = c("Study 1", "Study 2 (M1)", "Study 2 (M2)", "Study 2 (M3)"))
...
ggplot(data = behaviour_df,
  ...
  facet_grid(vars(facet), vars(Behaviour), scales = "free") +
  theme_bw() +
...
Pre-processing was the same as in study 1, excluding no participants for rushing and excluding `r print(study2_novariance_observations)` out of `r print(study2_total_instrument_observations)` (`r printnum(study2_novariance_observations/study2_total_instrument_observations*100, digits = 2)`%) responses due to a lack of variance in response patterns (for this study, we calculated variance per survey page rather than per instrument). 
...
```{r}
#| label: s2-eventexperience-change
#| include: false

# calculate pre-post changes in event experience variables
s2_changes <- study2_df %>%
  mutate(positivity_c = post_pleasure - base_pleasure,
         relaxation_c = post_tense*(-1) - base_tense*(-1), # flip poles because in the text I use the positively connotated anchors
         alert_c = post_awake - base_awake)

# create first plot by item
study2_df %>%
  pivot_longer(cols = c(enjoy, interest, moved, insight, concentration, chills, tears, reengage, post_duration), names_to = "Engagement", values_to = "Rating") %>%
  mutate(Engagement = factor(Engagement, levels = c("concentration", "interest", "enjoy", "insight", "moved", "reengage", "chills", "tears", "post_duration"), labels = c("Concentration", "Interest", "Enjoy", "Insight", "Moved", "Reengage", "Chills", "Tears", "Duration"))) %>%
  ggplot(aes(x = Engagement, y = Rating, fill = group)) +
...
TODO report sense of presence

As in study 1, participants' positivity (`r print_descr(s2_changes$positivity_c)`), relaxation (`r print_descr(s2_changes$relaxation_c)`), and alertness (`r print_descr(s2_changes$alert_c)`) tended to decrease throughout the event. Even though the event was half the length of the original one in study 1, decreases in relaxation and alertness were even larger in study 2 and participants had a stronger tendency to rate the event as too long `r print_descr(study2_df$post_duration)`. Nonetheless, participants reported attentiveness (`r print_descr(study2_df$concentration)`) and insightfulness (`r print_descr(study2_df$insight)`) at similarly high levels as in study 1, and only slightly lower levels of interest (`r print_descr(study2_df$interest)`), enjoyment (`r print_descr(study2_df$enjoy)`), and feeling moved (`r print_descr(study2_df$moved)`). The self-reported event experience did not differ between participants who watched the film or the performance. Thus, study 2 provided a comparable experience to study 1. 
...
# Check correlations with control variables
dv_corr("ios_anna_z", control_vars, study2_dichotom, output = "table") # liking r = .39
dv_corr("ios_target_z", control_vars, study2_dichotom, output = "table") 
dv_corr("anna_empathic_concern_z", control_vars, study2_dichotom, output = "table") 
dv_corr("target_empathic_concern_z", control_vars, study2_dichotom, output = "table")
dv_corr("problem_awareness_z", control_vars, study2_dichotom, output = "table") 
dv_corr("behavioural_intention_z", control_vars, study2_dichotom, output = "table") # liking r = .41
dv_corr("behavioural_intention_z", control_vars, subset(study2_dichotom, timepoint == "End"), output = "table") # liking r = .47
dv_corr("behavioural_intention_z", control_vars, subset(study2_dichotom, timepoint == "Baseline"), output = "table") # liking r = .35
dv_corr("sum_behaviour", control_vars, subset(study2_dichotom, timepoint == "End"), method = "spearman", output = "table") # liking r = .44
...
# dichotomize/z-score covariates
study2_long <- study2_long %>%
  mutate(identity_lgbq_dich = case_when(identity_lgbq == 1 ~ 1,
                                        .default = 0),
         identity_none_dich = case_when(identity_none == 1 ~ 1,
                                        .default = 0),
         liking_z = my_z_score(liking),
         # for Bartlett test:
         cell = paste(group, timepoint))

#### Awareness LMM ###

# s2_awareness_lmm <- lmer(problem_awareness_z ~ group * timepoint + (1|p_id), data = study2_long)
# check_assumptions(s2_awareness_lmm, "problem_awareness_z", study2_long) # intercepts violate normality
# 
# # Extract random intercepts
# awareness_intercepts <- ranef(s2_awareness_lmm)$p_id
# # Find the indices of the most extreme residuals
# order(abs(awareness_intercepts$`(Intercept)`), decreasing = TRUE)[1:4] # indices: c(12, 171,  64, 145)
# rownames(awareness_intercepts)[c(8, 23, 76, 109)] # p_id = c("sub-on2109", "sub-on295",  "sub-on2156", "sub-on271")
# 
# rm(awareness_intercepts)

s2_awareness_lmm <- lmer(problem_awareness_z ~ group * timepoint + (1|p_id), data = subset(study2_long, !p_id %in% c("sub-on2105", "sub-on2119")))
# check_assumptions(s2_awareness_lmm, "problem_awareness_z", subset(study2_long, !p_id %in% c("sub-on2105", "sub-on2119"))) # removing two outliers improves intercept Q-Q plot, but shapiro test still significant
...
# anna_empathy_lmm <- lmer(anna_empathic_concern_z ~ group * timepoint + (1|p_id), data = study2_long)
# check_assumptions(anna_empathy_lmm, "anna_empathic_concern_z", study2_long) # normality of residuals and intercepts violated
# 
# study2_long <- study2_long %>%
#   mutate(anna_empathy_log = log(anna_empathic_concern), # worse
#          anna_empathy_sqrt = sqrt(anna_empathic_concern), # worse
#          anna_empathy_recpr = 1/anna_empathic_concern) # the worst
# 
# # Extract and standardize residuals
# anna_empathy_residuals <- resid(anna_empathy_lmm, type = "pearson")
# # Find the indices of the most extreme residuals
# order(abs(anna_empathy_residuals), decreasing = TRUE)[1:11]
# # Alternatively, plot outlier rows
# lattice::qqmath(anna_empathy_lmm, id=0.1, idLabels=~.obs)
# 
# rm(anna_empathy_residuals)

anna_empathy_lmm <- lmer(anna_empathic_concern_z ~ group * timepoint + (1|p_id), data = study2_long[-c(191, 192,  66,   7,   8,  65,  77, 104, 158, 147), ])
# check_assumptions(anna_empathy_lmm, "anna_empathic_concern_z", study2_long[-c(191, 192,  66,   7,   8,  65,  77, 104, 158, 147), ]) # normality of intercepts still violated

# anna_empathy_intercepts <- ranef(anna_empathy_lmm)$p_id
# order(anna_empathy_intercepts$`(Intercept)`, decreasing = T)[1:3] # 25, 69
# rownames(anna_empathy_intercepts)[c(36, 99, 81)] # "sub-on2120" "sub-on2160"
# which(study2_long$p_id %in% c("sub-on2130", "sub-on2188", "sub-on2171")) # 239 240 319 320
# 
# rm(anna_empathy_intercepts)
# 
# anna_empathy_lmm <- lmer(anna_empathic_concern_z ~ group * timepoint + (1|p_id), data = study2_long[-c(191, 192,  66,   7,   8,  65,  77, 104, 158, 147, 259, 260, 341, 342, 375, 376), ])
# check_assumptions(anna_empathy_lmm, "anna_empathic_concern_z", study2_long[-c(191, 192,  66,   7,   8,  65,  77, 104, 158, 147, 259, 260, 341, 342, 375, 376), ]) # normality of intercepts STILL violated
...
target_empathy_lmm <- lmer(target_empathic_concern_z ~ group * timepoint + (1|p_id), data = study2_long)
# check_assumptions(target_empathy_lmm, "target_empathic_concern_z", study2_long) # normality of intercepts violated

# target_empathy_intercepts <- ranef(target_empathy_lmm)$p_id
# order(target_empathy_intercepts$`(Intercept)`, decreasing = T)[1:8] # 40, 115, 99, 144
# rownames(target_empathy_intercepts)[c(36, 117, 132, 189)] # "sub-on2139", "sub-on260", "sub-on242", "sub-on29"
# 
# target_empathy_lmm <- lmer(target_empathic_concern_z ~ group * timepoint + (1|p_id), data = subset(study2_long, !p_id %in% c("sub-on2130", "sub-on2203", "sub-on234",  "sub-on286", "sub-on23",   "sub-on296",  "sub-on260",  "sub-on294")))
# check_assumptions(target_empathy_lmm, "target_empathic_concern_z", subset(study2_long, !p_id %in% c("sub-on2130", "sub-on2203", "sub-on234",  "sub-on286", "sub-on23",   "sub-on296",  "sub-on260",  "sub-on294"))) # normality of intercepts STILL violated
...
# check_assumptions(anna_closeness_lmm, "ios_anna_z", study2_long) # residuals and intercepts violate normality

# # Extract and standardize residuals
# anna_closeness_residuals <- resid(anna_closeness_lmm, type = "pearson")
# # Find the indices of the most extreme residuals
# order(abs(anna_closeness_residuals), decreasing = T)[1:6] # 29 30 57 63 58 64 ISSUE: list of residuals is shorter than original df, therefore indices change. Use number names instead of indices
# anna_closeness_residuals[c(31, 32, 63, 71, 64, 72)] # indices: 31, 32, 63, 69, 64, 70
# 
# rm(anna_closeness_residuals)
# 
# anna_closeness_lmm <- lmer(ios_anna_z ~ liking_z + group * timepoint + (1|p_id), data = study2_long[-c(33,        34,        69,        77,        70,        78), ])
# check_assumptions(anna_closeness_lmm, "ios_anna_z", study2_long[-c(33,        34,        69,        77,        70,        78), ]) # assumptions are still violated
...
target_closeness_lmm <- lmer(ios_target_z ~ group * timepoint + (1|p_id), data = study2_long)
# check_assumptions(target_closeness_lmm, "ios_target_z", study2_long) # residuals & intercepts violate normality

# study2_long <- study2_long %>%
#   mutate(target_closeness_log = log(ios_target), # worse
#          target_closeness_sqrt = sqrt(ios_target), # worse
#          target_closeness_recpr = 1/ios_target) # the worst
#
# target_closeness_intercepts <- ranef(target_closeness_lmm)$p_id
# order(target_closeness_intercepts$`(Intercept)`, decreasing = T)[1:8] # 40, 115, 99, 144
# rownames(target_closeness_intercepts)[c(3, 145, 198,  36, 182, 187,  43,  47)] # "sub-on2139", "sub-on260", "sub-on242", "sub-on29"

# target_closeness_lmm <- lmer(ios_target_z ~ group * timepoint + (1|p_id), data = subset(study2_long, !p_id %in% c("sub-on2100", "sub-on246",  "sub-on294",  "sub-on2130", "sub-on28",   "sub-on284",  "sub-on2137", "sub-on2140")))
# check_assumptions(target_closeness_lmm, "ios_target_z", subset(study2_long, !p_id %in% c("sub-on2100", "sub-on246",  "sub-on294",  "sub-on2130", "sub-on28",   "sub-on284",  "sub-on2137", "sub-on2140"))) # that's worse for some reason

summary(target_closeness_lmm)
my_effectsize(target_closeness_lmm)

#### Behavioural intention LMM ###
# s2_intention_lmm <- lmer(behavioural_intention_z ~ liking_z + group * timepoint + (1|p_id), data = study2_long)
# check_assumptions(s2_intention_lmm, "behavioural_intention_z", study2_long) # non-normal residuals & intercepts
# 
# # Extract and standardize residuals
# intention_residuals <- resid(s2_intention_lmm, type = "pearson")
# # Find the most extreme residuals
# order(abs(intention_residuals), decreasing = T)[1:7] # 149 150 297 298
# # look up their indices
# intention_residuals[c(301, 160, 159,  83,  66, 246, 302)] # 149       150       297       298
# 
# rm(intention_residuals)

s2_intention_lmm <- lmer(behavioural_intention_z ~ liking_z + group * timepoint + (1|p_id), data = study2_long[-c(319,       168), ])
# check_assumptions(s2_intention_lmm, "behavioural_intention_z", study2_long[-c(319,       168), ]) # now, residuals & intercepts are normal

summary(s2_intention_lmm)
my_effectsize(s2_intention_lmm)
```
```{r}
#| label: study2-subset-tests
#| include: false

# test increase separately for film and performance
t.test(subset(study2_df, group == "group_film")$post_problem_awareness, subset(study2_df, group == "group_film")$base_problem_awareness, paired = T, alternative = "greater")
t.test(subset(study2_df, group == "group_perf")$post_problem_awareness, subset(study2_df, group == "group_perf")$base_problem_awareness, paired = T, alternative = "greater")

t.test(subset(study2_df, group == "group_film")$post_anna_empathic_concern, subset(study2_df, group == "group_film")$base_anna_empathic_concern, paired = T, alternative = "greater")
t.test(subset(study2_df, group == "group_perf")$post_anna_empathic_concern, subset(study2_df, group == "group_perf")$base_anna_empathic_concern, paired = T, alternative = "greater")

t.test(subset(study2_df, group == "group_film")$post_ios_anna, subset(study2_df, group == "group_film")$base_ios_anna, paired = T, alternative = "greater")
t.test(subset(study2_df, group == "group_perf")$post_ios_anna, subset(study2_df, group == "group_perf")$base_ios_anna, paired = T, alternative = "greater")
```

As opposed to study 1, openness and political orientation had associations smaller than $r = .3$ with problem awareness and were not included as covariates in the model. Consistent with study 1, the model $Awareness \sim Stimulus * Time + (1|Participant)$ yielded the hypothesized small effect of time `r eval_fixed(s2_awareness_lmm, "timepointPostvsPre")`, with participants reporting higher problem awareness after the event (`r print_descr(study2_df$post_problem_awareness)`) than before (`r print_descr(study2_df$base_problem_awareness)`; see @fig-awareness). The stimuli did not have a significant main effect or interaction with stimuli

### Empathy

We fitted two LMMs for empathy with Anna Vasquez and with a hypothetical victim of wrongful imprisonment separately. As expected, empathy with Anna Vasquez showed a small increase from baseline (`r print_descr(study2_df$base_anna_empathic_concern)`) to after the event (`r print_descr(study2_df$post_anna_empathic_concern)`), `r eval_fixed(anna_empathy_lmm, "timepointPostvsPre")` (see @fig-empathy). The stimuli also had a small main effect, `r eval_fixed(anna_empathy_lmm, "groupPerfvsFilm")`, with higher empathy both before and after watching the film, compared to the performance, but the interaction of time and stimuli found in study 1 did not replicate. Empathy with the hypothetical victim showed a very small increase from baseline (`r print_descr(study2_df$base_target_empathic_concern)`) to after the event (`r print_descr(study2_df$post_target_empathic_concern)`), `r eval_fixed(target_empathy_lmm, "timepointPostvsPre")` (see @fig-empathy-2), whereas the main and interaction effects of the stimuli were not significant.
...
As for empathy, we also fitted separate LMMs for the closeness ratings towards the two target persons. Closeness with Anna Vasquez was associated with liking contemporary percussion (`r apa_print(cor.test(study2_long$ios_anna_z, study2_long$liking, method = "spearman"))$full_result`), hence this variable was controlled in the model. Time had a medium-sized effect on closeness with Anna Vasquez, `r eval_fixed(anna_closeness_lmm, "timepointPostvsPre")`, with higher closeness ratings after (`r print_descr(study2_df$post_ios_anna)`), compared to before the event (`r print_descr(study2_df$base_ios_anna)`; see @fig-closeness). However, we were unable to replicate the interaction between time and stimuli. Closeness with the hypothetical victim showed a smaller increase from before (`r print_descr(study2_df$base_ios_target)`) to after the event (`r print_descr(study2_df$post_ios_target)`), `r eval_fixed(target_closeness_lmm, "timepointPostvsPre")` (see @fig-closeness-2). Again, the main and interaction effects of the stimuli were not significant.
...
Participants' intentions to support a charity fighting wrongful imprisonment showed a small increase from baseline (`r print_descr(study2_df$base_behavioural_intention)`) to after the event (`r print_descr(study2_df$post_behavioural_intention)`), `r eval_fixed(s2_intention_lmm, "timepointPostvsPre")`, comparable to study 1. We compared several preregistered regression models to predict participants' charitable intentions at the end of the event. Since intentions were associated with liking contemporary percussion music, this variable was controlled for in all models. First, we predicted intentions from the variables used in study 1: $Intention \sim Liking + Closeness (Anna) + Empathy (Anna) + Awareness$. We replicated the effect of empathy with Anna Vasquez on intentions ($\beta = `r printnum(coef(summary(study2_intention_outcomes))["anna_empathic_concern_z", "Estimate"])`$, $t (`r printnum(nobs(study2_intention_outcomes) - summary(study2_intention_outcomes)$fstatistic[2] - 1, digits = 0)`) = `r printnum(coef(summary(study2_intention_outcomes))["anna_empathic_concern_z", "t value"])`$, $p = `r printnum(coef(summary(study2_intention_outcomes))["anna_empathic_concern_z", "Pr(>|t|)"], digits = 3)`$), but unexpectedly, closeness with Anna Vasquez ($\beta = `r printnum(coef(summary(study2_intention_outcomes))["ios_anna_z", "Estimate"])`$, $t (`r printnum(nobs(study2_intention_outcomes) - summary(study2_intention_outcomes)$fstatistic[2] - 1, digits = 0)`) = `r printnum(coef(summary(study2_intention_outcomes))["ios_anna_z", "t value"])`$, $p = `r printnum(coef(summary(study2_intention_outcomes))["ios_anna_z", "Pr(>|t|)"], digits = 3)`$) and problem awareness ($\beta = `r printnum(coef(summary(study2_intention_outcomes))["problem_awareness_z", "Estimate"])`$, $t (`r printnum(nobs(study2_intention_outcomes) - summary(study2_intention_outcomes)$fstatistic[2] - 1, digits = 0)`) = `r printnum(coef(summary(study2_intention_outcomes))["problem_awareness_z", "t value"])`$, $p < .001$) were stronger predictors of intentions. Together, the explained variance in intentions was $R^2_{adj} = `r printnum(summary(study2_intention_outcomes)$adj.r.squared)`$.

Next, we replaced the empathy target: $Intention \sim Liking + Closeness (Anna) + Empathy (Victim) + Awareness$. Counter to hypothesis 2, empathy with the hypothetical victim was a slightly weaker predictor of intentions ($\beta = `r printnum(coef(summary(study2_intention_outcomes2))["target_empathic_concern_z", "Estimate"])`$, $t (`r printnum(nobs(study2_intention_outcomes2) - summary(study2_intention_outcomes2)$fstatistic[2] - 1, digits = 0)`) = `r printnum(coef(summary(study2_intention_outcomes2))["target_empathic_concern_z", "t value"])`$, $p = `r printnum(coef(summary(study2_intention_outcomes2))["target_empathic_concern_z", "Pr(>|t|)"], digits = 3)`$) than empathy with Anna Vasquez, and the model did not have a better variance explanation ($R^2_{adj} = `r printnum(summary(study2_intention_outcomes2)$adj.r.squared)`$). 

Finally, we exploratively replaced the closeness target as well: $Intention \sim Liking + Closeness (Victim) + Empathy (Victim) + Awareness$. Closeness with the hypothetical victim was a slightly weaker predictor of intentions ($\beta = `r printnum(coef(summary(study2_intention_outcomes3))["ios_target_z", "Estimate"])`$, $t (`r printnum(nobs(study2_intention_outcomes3) - summary(study2_intention_outcomes3)$fstatistic[2] - 1, digits = 0)`) = `r printnum(coef(summary(study2_intention_outcomes3))["ios_target_z", "t value"])`$, $p = `r printnum(coef(summary(study2_intention_outcomes3))["ios_target_z", "Pr(>|t|)"], digits = 3)`$) than closeness with Anna Vasquez, and the variance explained did not increase ($R^2_{adj} =`r printnum(summary(study2_intention_outcomes3)$r.squared)`$; see @tbl-regression-intention). 
...
# behaviour ~ intention TODO control for liking?
...
Looking at actual charitable behaviours in support of the charity *Innocence Canada*, `r sum(study2_df$behaviour_dich, na.rm = T)` (`r printnum(sum(study2_df$behaviour_dich, na.rm = T)/sum(!is.na(study2_df$behaviour_dich))*100)`%) participants performed at least one behaviour, a considerably lower rate than livestream particpants in study 1: `r sum(study2_df$flyer, na.rm = T)` participants downloaded flyer of the charity, `r sum(study2_df$mailing, na.rm = T)` signed up to their mailing list, and `r sum(study2_df$post_donation, na.rm = T)` made a donation, raising a total of CAD `r sum(study2_df$donation_amount, na.rm = T)` (see @fig-waffle-behaviour). As predicted (hypothesis 3b), a Wilcoxon rank-sum test revealed that no significant difference between participants who watched the film or the performance (`r apa_print(wilcox.test(sum_behaviour ~ group, data = study2_df))$full_result`). As predicted (hypothesis 3a), participants with higher intentions tended to demonstrate more behaviours (`r paste0("$OR = ", round(study2_sumbehav_intention_OR["post_behavioural_intention_z", "OR"], 2), "$, 95% CI [", round(study2_sumbehav_intention_OR["post_behavioural_intention_z", "CI_lower"], 2), ", ", round(study2_sumbehav_intention_OR["post_behavioural_intention_z", "CI_upper"], 2), "]")`). Intentions after the event explained a behavioural variance of $R_{Nagelkerke}^2 = `r printnum(r2_nagelkerke(study2_sumbehav_intention))`$. As opposed to study 1, however, intentions at baseline had more explanatory power for participants' actual behaviour ($R_{Nagelkerke}^2 = `r printnum(r2_nagelkerke(study2_sumbehav_baseintention))`$). 
...
# TODO check correlations with covariates

combined_awareness <- lmer(problem_awareness_z ~ timepoint * study + (1|p_id), data = combined_prepost)
check_assumptions(combined_awareness, "problem_awareness_z", combined_prepost) # TODO non-normal residuals and intercepts
...
To compare the effects of watching one stimulus or both stimuli (hypothesis 4), we fitted LMMs predicting empathy and closeness (with Anna Vasquez) and problem awareness based on time (pre vs. post) and study (study 1 vs. study 2), with random intercepts for participants. For awareness, there was a main effect of time, `r eval_fixed(combined_awareness, "timepointPostvsPre")`, which did not interact with the studies, indicating no difference between the increases in problem awareness in the two studies. For empathy, there was a main effect of time, `r eval_fixed(combined_empathy, "timepointPostvsPre")`, and a small main effect of the studies, `r eval_fixed(combined_empathy, "studystudy1vs2")`, indicating that participants in study 2 reported higher empathy than participants in study 1. However, the interaction between time and study was not significant, providing no support for differential increases in empathy from before to after the event. For closeness, there was a main effect of time, `r eval_fixed(combined_closeness, "timepointPostvsPre")`, which interacted with the studies, `r eval_fixed(combined_closeness, "timepointPostvsPre:studystudy1vs2")`, indicating larger increases in closeness in study 1 compared to study 2. Finally, even thouhgh the descriptive difference in the amount of charitable behaviours between the two studies pointed in the expected direction (hypothesis 5; see @fig-waffle-behaviour), this difference was not significance in a Wilcoxon rank-sum test, `r apa_print(wilcox.test(sum_behaviour ~ study, data = combined_prepost, subset = attendance == "Livestream" & timepoint == "End"))$full_result`.

<!-- TODO Wilcox test with only study1 livestream data (cf. prereg)-->
...
# study1_4long <- study1_3long %>%
#   mutate(
#     stimulustime = case_when(
#       order == "Film first" & timepoint == "Baseline" ~ "Pre-Documentary",
#       order == "Film first" & timepoint == "Intermission" ~ "Pre-Performance",
#       order == "Film first" & timepoint == "End" ~ "Post-Performance",
#       order == "Perf first" & timepoint == "Baseline" ~ "Pre-Performance",
#       order == "Perf first" & timepoint == "Intermission" ~ "Post-Performance",
#       order == "Perf first" & timepoint == "End" ~ "Post-Documentary"
#     ),
#     stimulustime = factor(
#       stimulustime, 
#       levels = c("Pre-Documentary", "Pre-Performance", "Post-Performance", "Post-Documentary"))
#   )

emotion_labels <- c(
  "jitter_awake" = "awake",
  "jitter_pleasure" = "pleasure",
  "jitter_tense" = "tense",
  "Study 1 In-person" = "Study 1 In-person",
  "Study 1 Livestream" = "Study 1 Livestream",
  "Study 2 Stream" = "Study 2 Stream"
)

combined_long %>%
  pivot_longer(
    cols = all_of(c("jitter_pleasure", "jitter_awake", "jitter_tense")),
    names_to = "Emotion",
    values_to = "emotion_value"
  ) %>%
  plot_meanSE(df = ., dv = "emotion_value", ylab = "Emotion", xlab = "Stimulus", colors = medium_cols) + 
  facet_grid(cols = vars(facet), 
             rows = vars(Emotion),
             scales = "free",
             labeller = as_labeller(emotion_labels)) +
...
# use combined_long$facet variable, y = engagement_variable, x = -3.5 bis +6.5, plot orange and blue pointranges 
combined_long %>%
  filter(medium != "Baseline") %>%
  pivot_longer(
    cols = c(enjoy, interest, moved, insight, concentration, chills, tears, reengage, duration), 
    names_to = "Engagement", 
    values_to = "engagement_rating"
  ) %>%
  mutate(
    Engagement = fct_reorder(Engagement, engagement_rating, .fun = "mean"),
    Order = order
  ) %>%
  ggplot(
    aes(x = engagement_rating,
         y = Engagement,
         group = interaction(medium, Order),
         color = medium,
        linetype = Order,
        shape = Order)) + 
  stat_summary(
  ...
  labs(x = "Rating") +
  scale_color_manual(values = medium_cols, name = "Stimulus") +
  facet_grid(cols = vars(facet)) + 
  theme_bw() +
...
model_comp_table <- matrix(ncol = 2, nrow = 0) %>% # initiate table structure
  ...
  rbind(c("  Full Model", "Intention \\textasciitilde SocialJusticeMotivation + TraitEmpathicConcern + Baseline + Attendance * Stimulus * Time + (1|Participant)")) %>%
...
library(effectsize)
conflicts_prefer(effsize::cohen.d)



cat("##### Comparison: Study 1 Peformance (1st half only) #####")

## subset the data
s1_perffirst <- subset(study1_df, order == "Perf first")

## Calculate effect sizes
cat("S1 Awareness")
cohen.d(s1_perffirst$base_problem_awareness, s1_perffirst$perfo_problem_awareness, paired = TRUE, na.rm = TRUE) # converges with my_effectsize() output

cat("S1 Empathy")
cohen.d(s1_perffirst$base_anna_empathic_concern, s1_perffirst$perfo_anna_empathic_concern, paired = TRUE, na.rm = TRUE)

cat("S1 Closeness")
cohen.d(s1_perffirst$base_ios_anna, s1_perffirst$perfo_ios_anna, paired = TRUE, na.rm = TRUE)

cat("S1 Intention")
cohen.d(s1_perffirst$base_behavioural_intention, s1_perffirst$perfo_behavioural_intention, paired = TRUE, na.rm = TRUE)

## Regression of behavioural intention
s1_perffirst <- s1_perffirst %>%
  mutate(
    across(.cols = all_of(c("perfo_ios_anna", "perfo_anna_empathic_concern", "perfo_problem_awareness", "perfo_behavioural_intention", "trait_empathic_concern")), .fns = my_z_score, .names = "{.col}_z"),
    motivation_socialjustice_dich = factor(motivation_socialjustice, levels = c(0, 1), labels = c("No", "Yes"))
    )
s1_regr_intent <- lm(perfo_behavioural_intention_z ~ trait_empathic_concern_z + motivation_socialjustice_dich + perfo_ios_anna_z + perfo_problem_awareness_z + perfo_anna_empathic_concern_z, data = s1_perffirst)
summary(s1_regr_intent)

## Plot behaviour
s1_behaviour <- s1_perffirst %>%
ggplot(aes(x = 1,
           y = behaviour_dich)
       ) + 
  stat_summary(
  ...
  stat_summary(
    fun = mean,
    geom = "text",
    aes(label = sprintf("%.0f%%", ..y.. * 100)),
    colour = "white",
    size   = 5,
    vjust  = 2
  ) +
  labs(x = NULL,
       y = "Participants who Supported Charity") +
  scale_x_continuous(breaks = NULL) +
  scale_y_continuous(limits = c(0, 1),
                     expand = c(0, 0),
                     labels=scales::percent) +
  papaja::theme_apa()
ggsave("Innocents_Prosociality_Manuscript_files/sysmus26/s1_behaviour.png", plot = s1_behaviour, width = 2, height = 4)



cat("##### Study 2 Peformance only #####")

table(study2_df$group)

## Subset the data
s2_perf <- subset(study2_df, group == "group_perf")

## Calculate effect sizes
cat("S2 Awareness")
cohen.d(s2_perf$base_problem_awareness, s2_perf$post_problem_awareness, paired = TRUE) # converges with my_effectsize() output

cat("S2 Empathy")
cohen.d(s2_perf$base_anna_empathic_concern, s2_perf$post_anna_empathic_concern, paired = TRUE)

cat("S2 Closeness")
cohen.d(s2_perf$base_ios_anna, s2_perf$post_ios_anna, paired = TRUE)

cat("S2 Intention")
cohen.d(s2_perf$base_behavioural_intention, s2_perf$post_behavioural_intention, paired = TRUE)

## Regression of behavioural intention
s2_perf <- s2_perf %>%
  mutate(
    across(.cols = all_of(c("post_ios_anna", "post_anna_empathic_concern", "post_problem_awareness", "post_behavioural_intention", "liking")), .fns = my_z_score, .names = "{.col}_z")
    )
s2_regr_intention <- lm(post_behavioural_intention_z ~ liking_z + post_ios_anna_z + post_anna_empathic_concern_z + post_problem_awareness_z, data = s2_perf)
summary(s2_regr_intention)



## Plot attitude changes across both studies
s2_attitudechange <- s2_perf %>%
  mutate(awareness_change = post_problem_awareness - base_problem_awareness,
         empathy_change = post_anna_empathic_concern - base_anna_empathic_concern,
         ios_anna_change = post_ios_anna - base_ios_anna,
         sample = "Online Replication") %>%
  select(sample, awareness_change, empathy_change, ios_anna_change, behaviour_dich)
combined_change <- s1_perffirst %>%
  mutate(awareness_change = perfo_problem_awareness - base_problem_awareness,
         empathy_change = perfo_anna_empathic_concern - base_anna_empathic_concern,
         ios_anna_change = perfo_ios_anna - base_ios_anna, 
         sample = case_match(attendance,
                             "In-person" ~ "Study 1 In-person",
                             "Livestream" ~ "Study 1 Livestream")) %>%
  select(sample, awareness_change, empathy_change, ios_anna_change, behaviour_dich) %>%
  bind_rows(s2_attitudechange)

attitudechangeplot <- combined_change %>%
  pivot_longer(cols = c(awareness_change, empathy_change, ios_anna_change), names_to = "Attitude", values_to = "Change") %>%
  mutate(Attitude = factor(Attitude, 
                           levels = c("awareness_change", "empathy_change", "ios_anna_change"), 
                           labels = c("Awareness", "Empathy", "Closeness")),
         sample = factor(sample, levels = c("Study 1 In-person", "Study 1 Livestream", "Online Replication")), 
         change_capped = pmax(pmin(Change, 2.5), -2)
         ) %>%
  ggplot(aes(x = sample,
             y = Change,
             group = sample,
  ...
  geom_point(aes(y = change_capped),
             color = "grey",
             alpha = .4,
             size = 2,
...
ggsave("Innocents_Prosociality_Manuscript_files/sysmus26/attitudechangecapped.png", plot = attitudechangeplot, width = 8, height = 6)

## Plot behaviour across both studies
combinedbehaviourplot <- combined_change %>%
  mutate(sample = factor(sample, 
                         levels = c("Study 1 In-person", "Study 1 Livestream", "Online Replication"))) %>%
  ggplot(aes(x = sample,
             y = behaviour_dich,
             fill = sample)) +
  stat_summary(
  ...
  theme(legend.position="none",
        axis.text.x = element_text(angle=30, hjust=0.9))
ggsave("Innocents_Prosociality_Manuscript_files/sysmus26/s1s2behaviour.png", plot = combinedbehaviourplot, width = 4, height = 6)
```
