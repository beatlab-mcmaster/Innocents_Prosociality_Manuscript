...
# # Find the indices of the most extreme residuals
# order(abs(anna_closeness_residuals), decreasing = F)[1:6] # 27  57  28  58  67 282
# lattice::qqmath(anna_closeness_lmm, id=0.1, idLabels=~.obs)
# 
# rm(anna_closeness_residuals)
# 
# anna_closeness_lmm <- lmer(ios_anna_z ~ liking_z + group * timepoint + (1|p_id), data = study2_long[-c(27,  57,  28,  58,  67, 282), ])
# check_assumptions(anna_closeness_lmm, "ios_anna_z", study2_long[-c(27,  57,  28,  58,  67, 282), ]) # the same outliers are still there?!
...
s2_intention_lmm <- lmer(behavioural_intention_z ~ group * timepoint + (1|p_id), data = study2_long)
