...
Pre-processing was the same as in study 1, excluding no participants for rushing and excluding `r print(study2_novariance_observations)` out of `r print(study2_total_instrument_observations)` (`r printnum(study2_novariance_observations/study2_total_instrument_observations, digits = 2)`%) responses due to a lack of variance in response patterns (for this study, we calculated variance per survey page rather than per instrument). 
...
TODO plot engagement items from both studies, maybe also factor analysis?
